...
@Component({
          ...
          <div class="project-card fade-in-up" 
            ...
            <div class="card-content">
              <div class="card-meta">
                ...
                <div class="links">
                  <a *ngIf="project.githubUrl" [href]="project.githubUrl" target="_blank" class="icon-link" title="Source Code">
                    <img src="https://cdn.simpleicons.org/github/white" alt="GitHub">
                  </a>
                  <a *ngIf="project.liveUrl" [href]="project.liveUrl" target="_blank" class="icon-link" title="Live Preview" [style.color]="'#818cf8'">
              ...
              <div class="tech-row">
                <span class="tech-pill" *ngFor="let tech of project.techStack | slice:0:4">{{ tech }}</span>
                <span class="tech-more" *ngIf="project.techStack.length > 4">+{{ project.techStack.length - 4 }}</span>
              </div>
            </div>
  ...
  styles: [`
    ...
    .card-visual {
      ...
      position: relative;
      overflow: hidden;
      group: group; /* Enable group-hover logic if using tailwind, but here we use pure css nesting */
    }
    ...
    .project-card:hover .live-preview-btn {
      opacity: 1;
